...
<a href="<?php echo get_permalink(get_the_ID())?>">
    <div class="post-item-container">
        <div class="post-item-feature">
            <picture>
                <source srcset="<?php the_image_crop_url(get_the_post_thumbnail_url(get_the_ID()),1037,408);?>" media="(min-width: 1025px)">
                ...
                <img src="<?php the_image_crop_url(get_the_post_thumbnail_url(get_the_ID()),1037,408);?>" alt="img">
            </picture>
        </div>
